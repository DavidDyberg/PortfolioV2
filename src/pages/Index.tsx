      ...
      <section id="about" className="container py-24">
        <div className="max-w-3xl">
          ...
          <h2 className="text-4xl md:text-5xl font-bold mb-6">
            A curious, collaborative fullstack developer.
          </h2>
          <p className="text-muted-foreground text-lg leading-relaxed mb-4">
            Hi! My name is David, and I am a curious and solution oriented
            fullstack developer. I'm a prestigeless person and enjoy
            collaborating with others.
          </p>
          <p className="text-muted-foreground text-lg leading-relaxed">
            Former colleagues have described me as easy to work with and quick
            to learn new things.
          </p>
        </div>
      </section>
